      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="probootstrap-menu">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active"><a class="nav-link" href="Login.jsp">Login/Register</a></li>
        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md">
            ...
            <p class="probootstrap-animate">
              <a href="Login.jsp" role="button" class="btn btn-primary p-3 mr-3 pl-5 pr-5 text-uppercase d-lg-inline d-md-inline d-sm-block d-block mb-3">Go to system now</a> 
            </p>
          </div> 
        </div>
      </div>
